...
export default function Main() {
  ...
  // TODO 2: Create marksThreshold state starting with empty string ''
  // Hint: const [marksThreshold, setMarksThreshold] = useState('');

  // TODO 3: Create filteredStudents state
  // - Initialize with students array (from TODO 1)
  // - This will hold the filtered list of students
  // Hint: const [filteredStudents, setFilteredStudents] = useState(students);

  // TODO 4: Create useEffect hook to filter students when marksThreshold changes
  // - Dependencies should include marksThreshold and students
  // - If marksThreshold is empty, show all students
  // - Otherwise, filter students with marks >= threshold
  // Hint: useEffect(() => { ... }, [marksThreshold, students]);
  // useEffect(() => {
  //   if (marksThreshold === '') {
